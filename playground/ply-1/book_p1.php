...
if(isset($_GET['date'])){
    $date = $_GET['date'];
    $stmt = $mysqli->prepare("select * from booking_p1 where date = ?");
...
if(isset($_POST['submit']))
    ...
    $stmt = $mysqli->prepare("select * from booking_p1 where date = ? AND timeslot = ?");
