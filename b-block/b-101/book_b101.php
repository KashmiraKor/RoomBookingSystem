...
if(isset($_GET['date'])){
    $date = $_GET['date'];
    $stmt = $mysqli->prepare("select * from booking_b101 where date = ?");
...
if(isset($_POST['submit']))
    ...
    $stmt = $mysqli->prepare("select * from booking_b101 where date = ? AND timeslot = ?");
    ...
    $stmt = $mysqli->prepare("INSERT INTO booking_b101 (username, name, emailid, department, event_name, date, timeslot) VALUES (?,?,?,?,?,?,?)");
  ...
  <body>
   ...
   <div class="col-md-12">
    ...
    <div class="col-md-2">
        ...
        <?php if(in_array($ts, $booking_b101)){ ?>
